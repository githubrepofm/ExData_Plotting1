...
epc_filter$Voltage<-as.numeric(gsub("?","",epc_filter$Voltage))
epc_filter$Global_reactive_power<-as.numeric(gsub("?","",epc_filter$Global_reactive_power))

x<-epc_filter$datatime
y<-epc_filter$Global_active_power

a<-epc_filter$Voltage
b<-epc_filter$Global_reactive_power
...
plot(x,a,type = "l",ylab = "Voltage",xlab = "datetime")
...
plot(x,b,type = "l",ylab = "Global_reactive_power",xlab = "datetime")
